...
function Mainfun(dataf::Matrix, people::Matrix, mkt_fips::Int64, year::Int64, modelparameters::Array{Float64, 2}, fids::Array{Int64};  idloc = 1, nsims = 500)
    ...
    #    print("Equilibrium Simulation, ", mkt_fips, " ", year, " ", "\n")
        states = Simulator(dataf, people, year, mkt_fips, modelparameters; T = 75)
        ...
        #    print("Perturbing Fid: ", pfid, "\n")
            ...
            perturbed_history = PerturbSimulator(dataf, people, year, mkt_fips, modelparameters, pfid; disturb = 0.01, T = 75)
