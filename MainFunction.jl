...
function Mainfun(dataf::Matrix, people::Matrix, mkt_fips::Int64, year::Int64, modelparameters::Array{Float64, 2}, fids::Array{Int64}; nsims = 10)
    ...
    #    print("Equilibrium Simulation, ", mkt_fips, " ", year, " ", "\n")
        states = Simulator(dataf, people, year, mkt_fips, modelparameters; T = 10)
...
# Here is a place to parallelize across the different fids
            perturbed_history = PerturbSimulator(dataf, people, year, mkt_fips, modelparameters, pfid; disturb = 0.01, T = 10)
