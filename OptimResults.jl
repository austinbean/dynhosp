...
inp1 = dfvec(fout1[1,4:93])
inp2 = dfvec(fout1[1,94:183])


function val1(x::Vector; inp1 = dfvec(fout1[1,4:93]), inp2 = dfvec(fout1[1,94:183]))
  return (minimum(sum(x.*(inp1 - inp2)), 0))^2
end
